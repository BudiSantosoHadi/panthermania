...
@section('container')
    ...
    <div class="g-white p-5 rounded">
        ...
        <div class="mb-3 mt-3 row">
            ...
            <div class="mt-2 mb-5 ">
                <img class="rounded " src="{{ asset('/data/uploads/photoKorwil/'. $data->logo_image) }}" width="23%" height="197px" id="img_output">
            </div>
            ...
            <a href="{{ route('korwilAdmin.index.korwil') }}" class="btn mt-4 mb-4 btn-primary">
            <span>back</span></a>
