...
@section('container')
    ...
    <div class="g-white p-5 rounded">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">EDIT DATA KORWIL</h1>
        </div>
        <hr>
        <div class="mb-3 mt-3 row">
            ...
            <form action="{{ route('korwilAdmin.update.korwil', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-sm-9">
                <input class="form-control @error('nama_korwil') is-invalid @enderror" value="{{ old('nama_korwil', $data->nama_korwil) }}" type="text" name="nama_korwil" id="nama_korwil" required>
            ...
            <div class="col-sm-9">
            <input class="form-control @error('nama_provinsi') is-invalid @enderror" type="text"  name="nama_provinsi" id="nama_provinsi" value="{{ old('nama_provinsi', $data->nama_provinsi) }}" style="width: 51%;">
            @error('nama_provinsi')
            ...
            <div class="col-sm-9">
            <input class="form-control @error('nama_kabupaten') is-invalid @enderror" type="text"  name="nama_kabupaten" id="nama_kabupaten" value="{{ old('nama_kabupaten', $data->nama_kabupaten) }}" style="width: 51%;">
            ...
            <a href="{{ route('korwilAdmin.index.korwil') }}" class="btn mt-4 mb-4 btn-danger">
            <span>batal</span></a>
            </form>
