...
@section('container')
    ...
    <div class="g-white p-5 rounded">
        ...
        <div class="mb-3 mt-3 row">
            ...
            <form action="{{ route('Admin.update.korwil', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-sm-9">
                <input class="form-control @error('nama_korwil') is-invalid @enderror" placeholder="nama korwil" value="{{ old('nama_korwil', $data->nama_korwil) }}" type="text" name="nama_korwil" id="nama_korwil" required>
            ...
            <div class="col-sm-9">
                <select class="form-control @error('nama_chapter') is-invalid @enderror" value="{{ old('nama_chapter', $data->nama_chapter) }}" type="text" name="nama_chapter" id="nama_chapter" required>
                    <option value="{{ old('nama_chapter', $data->nama_chapter) }}" disabled selected>{{ old('nama_chapter', $data->nama_chapter) }}</option>
            ...
            <div class="col-sm-9">
                <select class="form-control @error('nama_kabupaten') is-invalid @enderror" value="{{ old('nama_kabupaten',$data->nama_kabupaten) }}" type="text" name="nama_kabupaten" id="nama_kabupaten">
                    <option value="{{ old('nama_kabupaten',$data->nama_kabupaten) }}" disabled selected>{{ old('nama_kabupaten',$data->nama_kabupaten) }}</option>
