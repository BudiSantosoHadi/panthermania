...
@section('container')
    ...
    <div class="g-white p-5 rounded">
        ...
        <div class="mb-3 mt-3 row">
            ...
            <div class="mt-2 mb-5 ">
                <img class="rounded card card-body" style="background-repeat: no-repeat; background-size: cover;" src="{{ asset('/data/uploads/photoKorwil/'. $data->logo_image) }}" width="18%" height="178px" id="img_output">
            </div>
