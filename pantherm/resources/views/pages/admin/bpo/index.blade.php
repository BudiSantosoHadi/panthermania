...
@section('container')
    ...
    <div class="g-white p-5 rounded">
        ...
        <a href="{{ route('Admin.create.bpo') }}" class="d-block float-right d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
            class="fas fa-download fa-sm text-white-50"></i> Tambah Data</a>
        <hr>

        @forelse ($data as $no => $bpo )

            <a href="{{ route('Admin.edit.bpo', $bpo->id) }}" class="d-block d-sm-inline-block btn btn-sm btn-success shadow-sm"><i
